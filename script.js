...
[document.getElementById('canvasPlayerRow3'), document.getElementById('messageLower')]
...
async function shuffleTheDeck() {
    ...
    // deckUseage = new Array(52*4).fill(null).map((item)=>0)

    console.log('decUsage',deckUseage.length)
